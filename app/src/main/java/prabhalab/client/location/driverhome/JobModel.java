...
public class JobModel {
    ...
    public void setPickupTown(String pickupTown) {
    ...
    public String getMaskSuppliersPassenger() {
        return MaskSuppliersPassenger;
    }

    public void setMaskSuppliersPassenger(String maskSuppliersPassenger) {
        MaskSuppliersPassenger = maskSuppliersPassenger;
    }
